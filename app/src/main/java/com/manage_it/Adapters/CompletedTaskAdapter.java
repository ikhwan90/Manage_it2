...
public class CompletedTaskAdapter extends RecyclerView.Adapter<CompletedTaskAdapter.CompletedTasksViewHolder> {
    private List<ToDo> completedTasksArrayList;
    ...
    public CompletedTaskAdapter(List<ToDo> completedTasksArrayList, Context context) {
    ...
    public void onBindViewHolder(CompletedTasksViewHolder holder, int position) {
        final ToDo toDoItem = completedTasksArrayList.get(position);
