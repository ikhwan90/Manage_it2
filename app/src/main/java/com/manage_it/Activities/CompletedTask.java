...
import com.manage_it.Adapters.CompletedTaskAdapter;
...
import static com.manage_it.Utils.DBHelper.COMPLETED;
...
public class CompletedTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new CompletedTaskAdapter(mCompletedList,CompletedTask.this);
    ...
    private void setClickListeners() {
        mAdapter.setCompletedItemMenuListener(new CompletedTaskAdapter.CompletedItemMenu() {
            ...
            public void deleteTask(int position) {
                ...
                AlertDialog.Builder deleteDialogOk = new AlertDialog.Builder(CompletedTask.this);
    ...
    private class LoadCompletedTasks extends AsyncTask<Object,Void,List<ToDo>> {
