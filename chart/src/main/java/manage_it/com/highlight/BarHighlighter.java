...
import manage_it.com.data.BarEntry;
 ...
 */
public class BarHighlighter extends manage_it.com.highlight.ChartHighlighter<BarDataProvider> {
    ...
    public manage_it.com.highlight.Highlight getHighlight(float x, float y) {
        manage_it.com.highlight.Highlight high = super.getHighlight(x, y);
     ...
     * @return
     */
    public manage_it.com.highlight.Highlight getStackedHighlight(manage_it.com.highlight.Highlight high, IBarDataSet set, float xVal, float yVal) {
        ...
        if (entry.getYVals() == null) {
            ...
            if (ranges.length > 0) {
                ...
                manage_it.com.highlight.Highlight stackedHigh = new manage_it.com.highlight.Highlight(
                        entry.getX(),
                        entry.getY(),
                        (float) pixels.x,
                        (float) pixels.y,
