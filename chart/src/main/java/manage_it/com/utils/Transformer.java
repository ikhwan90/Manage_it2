...
import manage_it.com.data.CandleEntry;
...
public class Transformer {
     ...
     * @return
     */
    public manage_it.com.utils.MPPointD getValuesByTouchPoint(float x, float y) {

        manage_it.com.utils.MPPointD result = manage_it.com.utils.MPPointD.getInstance(0, 0);
        getValuesByTouchPoint(x, y, result);
        return result;
    }

    public void getValuesByTouchPoint(float x, float y, manage_it.com.utils.MPPointD outputPoint) {
     ...
     * @return
     */
    public manage_it.com.utils.MPPointD getPixelForValues(float x, float y) {
        ...
        return manage_it.com.utils.MPPointD.getInstance(xPx, yPx);
    }
