...
import manage_it.com.formatter.DefaultValueFormatter;
import manage_it.com.formatter.ValueFormatter;
...
public abstract class Utils {
    ...
    public static FSize calcTextSize(Paint paint, String demoText) {
        ...
        manage_it.com.utils.FSize result = manage_it.com.utils.FSize.getInstance(0,0);
     ...
     */
    public static void calcTextSize(Paint paint, String demoText, manage_it.com.utils.FSize outputFSize) {
     ...
     * @return
     */
    public static manage_it.com.utils.MPPointF getPosition(manage_it.com.utils.MPPointF center, float dist, float angle) {

        manage_it.com.utils.MPPointF p = manage_it.com.utils.MPPointF.getInstance(0,0);
        getPosition(center, dist, angle, p);
        return p;
    }

    public static void getPosition(manage_it.com.utils.MPPointF center, float dist, float angle, manage_it.com.utils.MPPointF outputPoint){
    ...
    public static void drawImage(Canvas canvas,
        ...
        manage_it.com.utils.MPPointF drawOffset = manage_it.com.utils.MPPointF.getInstance();
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
                                      Paint paint,
                                      manage_it.com.utils.MPPointF anchor, float angleDegrees) {
        ...
        if (angleDegrees != 0.f) {
            ...
            if (anchor.x != 0.5f || anchor.y != 0.5f) {
                final manage_it.com.utils.FSize rotatedSize = getSizeOfRotatedRectangleByDegrees(
                ...
                manage_it.com.utils.FSize.recycleInstance(rotatedSize);
            }
    ...
    public static void drawMultilineText(Canvas c, String text,
                                         float x, float y,
                                         TextPaint paint,
                                         manage_it.com.utils.FSize constrainedToSize,
                                         manage_it.com.utils.MPPointF anchor, float angleDegrees) {
     ...
     * @return A Recyclable FSize instance
     */
    public static manage_it.com.utils.FSize getSizeOfRotatedRectangleByDegrees(manage_it.com.utils.FSize rectangleSize, float degrees) {
     ...
     * @return A Recyclable FSize instance
     */
    public static manage_it.com.utils.FSize getSizeOfRotatedRectangleByRadians(manage_it.com.utils.FSize rectangleSize, float radians) {
        return getSizeOfRotatedRectangleByRadians(rectangleSize.width, rectangleSize.height,
                radians);
    }
     ...
     * @return A Recyclable FSize instance
     */
    public static manage_it.com.utils.FSize getSizeOfRotatedRectangleByDegrees(float rectangleWidth, float
     ...
     * @return A Recyclable FSize instance
     */
    public static manage_it.com.utils.FSize getSizeOfRotatedRectangleByRadians(float rectangleWidth, float
            rectangleHeight, float radians) {
        return manage_it.com.utils.FSize.getInstance(
