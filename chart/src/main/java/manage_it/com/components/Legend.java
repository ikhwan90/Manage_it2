package manage_it.com.components;

import android.graphics.DashPathEffect;
import android.graphics.Paint;

import manage_it.com.utils.ColorTemplate;
import manage_it.com.utils.FSize;
...
public class Legend extends ComponentBase {
     ...
     */
    private manage_it.com.components.LegendEntry[] mEntries = new manage_it.com.components.LegendEntry[]{};

    /**
     * Entries that will be appended to the end of the auto calculated entries after calculating the legend.
     * (if the legend has already been calculated, you will need to call notifyDataSetChanged() to let the changes take effect)
     */
    private manage_it.com.components.LegendEntry[] mExtraEntries;
     ...
     * @param entries
     */
    public Legend(manage_it.com.components.LegendEntry[] entries) {
        this();
    ...
    public Legend(int[] colors, String[] labels) {
        ...
        List<manage_it.com.components.LegendEntry> entries = new ArrayList<>();

        for (int i = 0; i < Math.min(colors.length, labels.length); i++) {
            final manage_it.com.components.LegendEntry entry = new manage_it.com.components.LegendEntry();
        ...
        mEntries = entries.toArray(new manage_it.com.components.LegendEntry[entries.size()]);
    }
     ...
     * @param entries
     */
    public void setEntries(List<manage_it.com.components.LegendEntry> entries) {
        mEntries = entries.toArray(new manage_it.com.components.LegendEntry[entries.size()]);
    }

    public manage_it.com.components.LegendEntry[] getEntries() {
        return mEntries;
    }
    ...
    public float getMaximumEntryWidth(Paint p) {
        ...
        for (manage_it.com.components.LegendEntry entry : mEntries) {
    ...
    public manage_it.com.components.LegendEntry[] getExtraEntries() {

        return mExtraEntries;
    }

    public void setExtra(List<manage_it.com.components.LegendEntry> entries) {
        mExtraEntries = entries.toArray(new manage_it.com.components.LegendEntry[entries.size()]);
    }

    public void setExtra(manage_it.com.components.LegendEntry[] entries) {
        if (entries == null)
            entries = new manage_it.com.components.LegendEntry[]{};
     ...
     */
    public void setCustom(manage_it.com.components.LegendEntry[] entries) {
     ...
     *   notifyDataSetChanged() is needed to auto-calculate the legend again)
     */
    public void setCustom(List<manage_it.com.components.LegendEntry> entries) {
    ...
    public void calculateDimensions(Paint labelpaint, ViewPortHandler viewPortHandler) {
        ...
        manage_it.com.components.LegendEntry[] entries = mEntries;
        ...
        switch (mOrientation) {
            case VERTICAL: {
                ...
                for (int i = 0; i < entryCount; i++) {
                    ...
                    manage_it.com.components.LegendEntry e = entries[i];
