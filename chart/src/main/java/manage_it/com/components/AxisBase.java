...
import manage_it.com.formatter.DefaultAxisValueFormatter;
 ...
 */
public abstract class AxisBase extends manage_it.com.components.ComponentBase {
     ...
     */
    protected List<manage_it.com.components.LimitLine> mLimitLines;
    ...
    public AxisBase() {
        ...
        this.mLimitLines = new ArrayList<manage_it.com.components.LimitLine>();
    }
     ...
     * @param l
     */
    public void addLimitLine(manage_it.com.components.LimitLine l) {
        mLimitLines.add(l);
     ...
     * @param l
     */
    public void removeLimitLine(manage_it.com.components.LimitLine l) {
     ...
     * @return
     */
    public List<manage_it.com.components.LimitLine> getLimitLines() {
        return mLimitLines;
    }
