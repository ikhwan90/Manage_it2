package manage_it.com.animation;
...
public class ChartAnimator {
    ...
    public void animateX(int durationMillis) {
        animateX(durationMillis, manage_it.com.animation.Easing.Linear);
    }
    ...
    public void animateXY(int durationMillisX, int durationMillisY) {
        animateXY(durationMillisX, durationMillisY, manage_it.com.animation.Easing.Linear, manage_it.com.animation.Easing.Linear);
    }
    ...
    public void animateY(int durationMillis) {
        animateY(durationMillis, manage_it.com.animation.Easing.Linear);
    }
