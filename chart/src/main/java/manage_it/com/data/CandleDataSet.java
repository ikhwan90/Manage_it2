...
import manage_it.com.interfaces.datasets.ICandleDataSet;
 ...
 */
public class CandleDataSet extends manage_it.com.data.LineScatterCandleRadarDataSet<manage_it.com.data.CandleEntry> implements ICandleDataSet {
    ...
    public CandleDataSet(List<manage_it.com.data.CandleEntry> yVals, String label) {
        super(yVals, label);
    }

    @Override
    public manage_it.com.data.DataSet<manage_it.com.data.CandleEntry> copy() {
        List<manage_it.com.data.CandleEntry> entries = new ArrayList<manage_it.com.data.CandleEntry>();
    ...
    @Override
    protected void calcMinMax(manage_it.com.data.CandleEntry e) {
    ...
    @Override
    protected void calcMinMaxY(manage_it.com.data.CandleEntry e) {
