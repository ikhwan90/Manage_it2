...
public class CombinedData extends BarLineScatterCandleBubbleData<IBarLineScatterCandleBubbleDataSet<? extends Entry>> {
    ...
    private manage_it.com.data.LineData mLineData;
    private BarData mBarData;
    private manage_it.com.data.ScatterData mScatterData;
    ...
    public void setData(manage_it.com.data.LineData data) {
        mLineData = data;
        notifyDataChanged();
    }
    ...
    public void setData(manage_it.com.data.ScatterData data) {
        mScatterData = data;
        notifyDataChanged();
    }
    ...
    public manage_it.com.data.LineData getLineData() {
        return mLineData;
    }
    ...
    public manage_it.com.data.ScatterData getScatterData() {
        return mScatterData;
    }
