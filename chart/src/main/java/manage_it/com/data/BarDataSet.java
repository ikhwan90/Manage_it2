...
import manage_it.com.interfaces.datasets.IBarDataSet;

import java.util.ArrayList;
import java.util.List;

public class BarDataSet extends manage_it.com.data.BarLineScatterCandleBubbleDataSet<manage_it.com.data.BarEntry> implements IBarDataSet {
    ...
    public BarDataSet(List<manage_it.com.data.BarEntry> yVals, String label) {
        super(yVals, label);
    ...
    @Override
    public manage_it.com.data.DataSet<manage_it.com.data.BarEntry> copy() {
        List<manage_it.com.data.BarEntry> entries = new ArrayList<manage_it.com.data.BarEntry>();
     ...
     */
    private void calcEntryCountIncludingStacks(List<manage_it.com.data.BarEntry> yVals) {
     ...
     * DataSet
     */
    private void calcStackSize(List<manage_it.com.data.BarEntry> yVals) {
    ...
    @Override
    protected void calcMinMax(manage_it.com.data.BarEntry e) {
