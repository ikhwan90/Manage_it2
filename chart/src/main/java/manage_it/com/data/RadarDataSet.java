...
import manage_it.com.interfaces.datasets.IRadarDataSet;
import manage_it.com.utils.ColorTemplate;

import java.util.ArrayList;
import java.util.List;

public class RadarDataSet extends LineRadarDataSet<manage_it.com.data.RadarEntry> implements IRadarDataSet {
    ...
    public RadarDataSet(List<manage_it.com.data.RadarEntry> yVals, String label) {
        super(yVals, label);
    }
    ...
    @Override
    public DataSet<manage_it.com.data.RadarEntry> copy() {
        List<manage_it.com.data.RadarEntry> entries = new ArrayList<manage_it.com.data.RadarEntry>();
