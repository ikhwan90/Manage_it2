...
import manage_it.com.interfaces.datasets.IPieDataSet;
import manage_it.com.utils.Utils;

import java.util.ArrayList;
import java.util.List;

public class PieDataSet extends DataSet<manage_it.com.data.PieEntry> implements IPieDataSet {
    ...
    public PieDataSet(List<manage_it.com.data.PieEntry> yVals, String label) {
        super(yVals, label);
//        mShift = Utils.convertDpToPixel(12f);
    }

    @Override
    public DataSet<manage_it.com.data.PieEntry> copy() {
        List<manage_it.com.data.PieEntry> entries = new ArrayList<>();
    ...
    @Override
    protected void calcMinMax(manage_it.com.data.PieEntry e) {
